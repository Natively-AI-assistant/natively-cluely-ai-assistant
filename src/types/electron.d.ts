import type { FetchableProvider, LLMProvider } from './providers';
...
export interface ElectronAPI {
  ...
  fetchProviderModels: (provider: FetchableProvider, apiKey: string) => Promise<{ success: boolean; models?: {id: string, label: string}[]; error?: string }>
  setProviderPreferredModel: (provider: LLMProvider, modelId: string) => Promise<void>
