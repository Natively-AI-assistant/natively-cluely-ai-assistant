...
export interface ElectronAPI {
  ...
  getCodexCliModels: () => Promise<{ success: boolean; models: Array<{ id: string; name: string; description?: string; hidden?: boolean; supportedReasoningEfforts?: string[]; defaultReasoningEffort?: string; inputModalities?: string[] }>; error?: string }>;
