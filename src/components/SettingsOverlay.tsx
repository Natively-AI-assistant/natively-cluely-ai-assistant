                                                ...
                                                <div className="relative">
                                                    <ProviderSelect
                                                        ...
                                                        options={[
                                                            ...
                                                            { id: 'deepgram', label: 'Deepgram Nova-3', badge: hasStoredDeepgramKey ? 'Saved' : null, recommended: true, desc: 'High-accuracy streaming transcription', color: 'purple', icon: <Mic size={14} /> },
