                                                ...
                                                <div className="relative">
                                                    <ProviderSelect
                                                        ...
                                                        options={[
                                                            ...
                                                            { id: 'nvidia_nim', label: 'NVIDIA NIM', badge: hasStoredNvidiaNimKey ? 'Saved' : null, desc: 'Low-latency Nemotron / Parakeet streaming ASR', color: 'green', icon: <BrandMark provider="nvidia_nim" />, neutralTile: true },
