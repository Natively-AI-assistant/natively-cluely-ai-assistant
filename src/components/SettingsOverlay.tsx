        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className={`fixed inset-0 z-50 flex items-center justify-center p-8 transition-colors duration-150 ${isPreviewingOpacity ? 'bg-transparent backdrop-blur-none pointer-events-none' : isLight ? 'bg-black/[0.03] backdrop-blur-[4px]' : 'bg-black/60'}`}
                    onClick={(e) => {
