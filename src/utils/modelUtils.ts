export const STANDARD_CLOUD_MODELS: Record<string, {
    ...
    openrouter: {
        ...
        ids: ['openrouter/auto', 'anthropic/claude-3.5-sonnet', 'openai/gpt-4o', 'deepseek/deepseek-r1'],
        names: ['Auto (Best Prompt)', 'Claude 3.5 Sonnet', 'GPT-4o', 'DeepSeek R1'],
        descs: ['Auto Router', 'Anthropic via OpenRouter', 'OpenAI via OpenRouter', 'Reasoning via OpenRouter'],
