...
# The embedded server's first CPU boot can take several minutes while the
# embedding/reranker weights are downloaded and loaded. Keep this aligned with
# HindsightManager's six-minute readiness poll; 180s caused the app to report a
# dead companion even though the child was still progressing toward readiness.
START_TIMEOUT = float(os.environ.get("HINDSIGHT_START_TIMEOUT", "360"))
