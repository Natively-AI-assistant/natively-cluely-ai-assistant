...
import { EmbeddingProviderResolver, AppAPIConfig } from '../../../electron/rag/EmbeddingProviderResolver'
...
describe('EmbeddingProviderResolver', () => {
    describe('resolve', () => {
        ...
        it('should return Local provider as fallback when no other providers available', async () => {
            ...
            const { OllamaEmbeddingProvider } = await import('../../../electron/rag/providers/OllamaEmbeddingProvider')
