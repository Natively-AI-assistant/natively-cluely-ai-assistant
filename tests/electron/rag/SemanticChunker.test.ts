...
} from '../../../electron/rag/SemanticChunker'
  ...
  describe('chunkTranscript', () => {
    ...
    it('groups segments into chunks', () => {
      const segments = [
        seg(
          'Alice',
          'This is a reasonable length segment about react components and how they work together in a typical application.',
          0,
          2000,
        ),
        seg(
          'Alice',
          'Another segment from the same speaker about state management and its importance in modern apps.',
          2000,
          4000,
        ),
      ]
    ...
    it('assigns sequential chunkIndex values', () => {
      const segments = [
        seg(
          'Alice',
          'First segment about the topic that is long enough to be meaningful and generate tokens for the chunk.',
          0,
          2000,
        ),
        seg(
          'Bob',
          'Second segment from different speaker that is also long enough to be meaningful for the chunk.',
          2000,
          4000,
        ),
        seg(
          'Alice',
          'Third segment from first speaker again with enough content to form a proper chunk of text.',
          4000,
          6000,
        ),
      ]
    ...
    it('splits on speaker change', () => {
      const segments = [
        seg(
          'Alice',
          'This is a segment from Alice that talks about react and its various features in detail.',
          0,
          2000,
        ),
        seg(
          'Bob',
          'This is a response from Bob about the same topic with his own perspective and thoughts.',
          2000,
          4000,
        ),
      ]
    ...
    it('does NOT carry overlap on speaker change boundaries', () => {
      const segments = [
        seg(
          'Alice',
          'Alice has a very long segment here about react and components and state management and hooks.',
          0,
          2000,
        ),
        seg(
          'Bob',
          'Bob responds with his own thoughts about the topic and how it relates to their project.',
          2000,
          4000,
        ),
      ]
    ...
    it('carries overlap on same-speaker split (token limit exceeded)', () => {
      ...
      const segments = [
        ...
        seg(
          'Alice',
          'Additional context from Alice that continues the thought and builds on the previous point.',
          2000,
          4000,
        ),
      ]
    ...
    it('correct startMs/endMs spanning', () => {
      const segments = [
        seg(
          'Alice',
          'First segment about a topic that is long enough to matter for our chunking algorithm.',
          1000,
          3000,
        ),
        seg(
          'Alice',
          'Second segment continuing the same topic with more detail and context for the meeting.',
          3000,
          5000,
        ),
      ]
    ...
    it('includes tokenCount in chunks', () => {
      const segments = [
        seg(
          'Alice',
          'This is a test segment with some content for token counting.',
          0,
          1000,
        ),
      ]
