...
vi.mock('@bany/curl-to-json', () => ({
    default: vi.fn((curl: string) => {
        ...
        return { url: 'https://api.example.com', method: 'POST', header: {}, data: '{}' }
    })
}))
...
describe('curlUtils', () => {
    describe('validateCurl', () => {
        ...
        it('accepts valid cURL with placeholder', () => {
            const result = validateCurl("curl -X POST https://api.example.com -d '{{TEXT}}'")
    ...
    describe('deepVariableReplacer', () => {
        ...
        it('replaces multiple variables in one string', () => {
            const result = deepVariableReplacer('{{GREETING}} {{NAME}}', { GREETING: 'Hi', NAME: 'Alice' })
    ...
    describe('imageMimeTypeFromPath', () => {
        ...
        it('handles full path with extension', () => {
            expect(imageMimeTypeFromPath('/home/user/images/photo.png')).toBe('image/png')
        })
