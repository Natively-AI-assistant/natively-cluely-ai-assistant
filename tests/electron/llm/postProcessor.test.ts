...
import {
  clampResponse,
  validateResponse,
} from '../../../electron/llm/postProcessor'
...
describe('postProcessor', () => {
  describe('clampResponse', () => {
    ...
    it('removes "Let me know if you" filler', () => {
      const result = clampResponse(
        'Use React hooks. Let me know if you need more.',
      )
  ...
  describe('validateResponse', () => {
    ...
    it('detects too many sentences', () => {
      ...
      expect(result.valid).toBe(false)
      expect(result.issues.some((i) => i.includes('Too many sentences'))).toBe(
        true,
      )
    })
