...
describe('prompts', () => {
  ...
  describe('buildWhatToAnswerContents', () => {
    it('returns an array with two content objects', () => {
      const result = prompts.buildWhatToAnswerContents(
  ...
  describe('buildFollowUpContents', () => {
    it('returns an array with two content objects', () => {
      const result = prompts.buildFollowUpContents(
        'Previous answer',
        'Make it shorter',
      )
      expect(result).toHaveLength(2)
  ...
  describe('buildCodeHintMessage', () => {
    it('includes coding question when provided with transcript source', () => {
      const result = prompts.buildCodeHintMessage(
        'Two Sum problem',
        'transcript',
        null,
      )
  ...
  describe('prompt constants', () => {
    ...
    it('all prompts enforce security rules', () => {
      const _securityPhrases = ["I can't share that information"]
      for (const prompt of [
