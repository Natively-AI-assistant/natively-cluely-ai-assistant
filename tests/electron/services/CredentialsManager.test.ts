...
describe('CredentialsManager', () => {
  ...
  describe('STT Provider Settings', () => {
    ...
    it('should get and set Groq STT model with default', () => {
      expect(credentialsManager.getGroqSttModel()).toBe(
    ...
    it('should get and set OpenAI STT API key', () => {
      ...
      expect(credentialsManager.getOpenAiSttApiKey()).toBe(
        'openai-stt-test-key',
      )
    })
    ...
    it('should get and set ElevenLabs API key', () => {
      ...
      expect(credentialsManager.getElevenLabsApiKey()).toBe(
        'elevenlabs-test-key',
      )
    })
  ...
  describe('Default Model', () => {
    it('should get and set default model', () => {
      expect(credentialsManager.getDefaultModel()).toBe(
  ...
  describe('Preferred Models', () => {
    it('should get and set preferred model per provider', () => {
      ...
      expect(credentialsManager.getPreferredModel('gemini')).toBe(
        'gemini-2.0-flash',
      )
  ...
  describe('Custom Providers', () => {
    ...
    it('should update existing custom provider', () => {
      const provider1 = {
        id: 'custom-1',
        name: 'Provider 1',
        curlCommand: 'curl test1',
      }
      const provider2 = {
        id: 'custom-1',
        name: 'Provider 1 Updated',
        curlCommand: 'curl test2',
      }
  ...
  describe('Google Service Account', () => {
    it('should get and set Google service account path', () => {
      credentialsManager.setGoogleServiceAccountPath(
        '/path/to/service-account.json',
      )
      expect(credentialsManager.getGoogleServiceAccountPath()).toBe(
        '/path/to/service-account.json',
      )
    })
  })
