...
import {
  ...
  TextModelFamily,
  versionDistance,
} from '../../../electron/services/ModelVersionManager'
...
describe('ModelVersionManager', () => {
  ...
  describe('parseModelVersion', () => {
    ...
    it('should parse Llama-style version', () => {
      const version = parseModelVersion(
  ...
  describe('classifyModel', () => {
    ...
    it('should classify Gemini Flash models', () => {
      expect(classifyModel('gemini-3.1-flash-lite-preview')).toBe(
    ...
    it('should classify Gemini Pro models', () => {
      expect(classifyModel('gemini-3.1-pro-preview')).toBe(
    ...
    it('should classify Groq Llama Scout models', () => {
      expect(classifyModel('meta-llama/llama-4-scout-17b-16e-instruct')).toBe(
  ...
  describe('classifyTextModel', () => {
    ...
    it('should classify Groq text models broadly', () => {
      expect(classifyTextModel('llama-3.3-70b-versatile')).toBe(
    ...
    it('should classify Claude text models', () => {
      expect(classifyTextModel('claude-sonnet-4-6')).toBe(
  ...
  describe('rollback', () => {
    ...
    it('should rollback to previous latest if available', () => {
      ...
      expect(result).toBe(true)
      // @ts-expect-error - accessing private state
      expect(manager.state.families[ModelFamily.GEMINI_FLASH].latest).toBe(
