...
describe('ModesManager', () => {
    beforeEach(async () => {
        ...
        const { ModesManager } = await import('../../../electron/services/ModesManager')
        const { DatabaseManager } = await import('../../../electron/db/DatabaseManager')
    ...
    describe('getActiveMode', () => {
        ...
        it('should return the newly set active mode', () => {
            const sales = mm.createMode({ name: 'Team Meet', templateType: 'team-meet' })
    ...
    describe('createMode', () => {
        it('should create a mode with the given name and template type', () => {
            const mode = mm.createMode({ name: 'My Sales Mode', templateType: 'sales' })
        ...
        it('should persist the created mode to the database', () => {
            const mode = mm.createMode({ name: 'Persisted', templateType: 'recruiting' })
        ...
        it('should seed 3 note sections for a general mode', () => {
            const general = mm.createMode({ name: 'Custom General', templateType: 'general' })
    ...
    describe('MODE_TEMPLATES', () => {
        it('should include all expected template types', () => {
            const expectedTypes = ['sales', 'recruiting', 'team-meet', 'looking-for-work', 'lecture']
