// OSS / skip-premium gate: original suite lives in RecallPrecisionTier2VsTier1_2026_07_25.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'RecallPrecisionTier2VsTier1_2026_07_25.premium-impl.mjs')).href);
}
