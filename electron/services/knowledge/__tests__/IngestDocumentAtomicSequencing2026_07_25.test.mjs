// OSS / skip-premium gate: original suite lives in IngestDocumentAtomicSequencing2026_07_25.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IngestDocumentAtomicSequencing2026_07_25.premium-impl.mjs')).href);
}
