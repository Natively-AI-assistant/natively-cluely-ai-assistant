// OSS / skip-premium gate: original suite lives in StarStoryEvidenceAuthorityGap2026_07_25.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'StarStoryEvidenceAuthorityGap2026_07_25.premium-impl.mjs')).href);
}
