// OSS / skip-premium gate: original suite lives in KnowledgeOrchestratorTypecheck.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'KnowledgeOrchestratorTypecheck.premium-impl.mjs')).href);
}
