// OSS / skip-premium gate: original suite lives in SkillCategorizationIngest.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'SkillCategorizationIngest.premium-impl.mjs')).href);
}
