// OSS / skip-premium gate: original suite lives in PronounRegexKnowledgeFork2026_07_24.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'PronounRegexKnowledgeFork2026_07_24.premium-impl.mjs')).href);
}
