// OSS / skip-premium gate: original suite lives in NegotiationStickinessAndCircuitBreaker.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'NegotiationStickinessAndCircuitBreaker.premium-impl.mjs')).href);
}
