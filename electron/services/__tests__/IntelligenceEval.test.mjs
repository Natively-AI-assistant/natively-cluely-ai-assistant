// OSS / skip-premium gate: original suite lives in IntelligenceEval.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IntelligenceEval.premium-impl.mjs')).href);
}
