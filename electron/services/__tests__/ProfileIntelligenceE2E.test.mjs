// OSS / skip-premium gate: original suite lives in ProfileIntelligenceE2E.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ProfileIntelligenceE2E.premium-impl.mjs')).href);
}
