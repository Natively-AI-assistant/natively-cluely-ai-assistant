...
import { parseCodexModelsPayload, activateCodexModelCatalog, resetCodexCatalogRefreshForTest } from '../../../dist-electron/electron/services/CodexModelCatalog.js';
...
describe('resolveCodexReasoningEffort — provider-derived capabilities', () => {
  test('accepts advertised values including future levels without a code change', () => {
    ...
    activateCodexModelCatalog(catalog.models);
  ...
  test('activating a new catalogue removes capabilities from the old account', () => {
    ...
    activateCodexModelCatalog(first.models);
    ...
    activateCodexModelCatalog(second.models);
