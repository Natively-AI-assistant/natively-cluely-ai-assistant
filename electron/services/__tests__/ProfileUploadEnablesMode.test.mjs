// OSS / skip-premium gate: original suite lives in ProfileUploadEnablesMode.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ProfileUploadEnablesMode.premium-impl.mjs')).href);
}
