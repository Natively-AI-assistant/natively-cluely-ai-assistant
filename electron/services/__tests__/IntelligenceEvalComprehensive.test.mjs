// OSS / skip-premium gate: original suite lives in IntelligenceEvalComprehensive.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IntelligenceEvalComprehensive.premium-impl.mjs')).href);
}
