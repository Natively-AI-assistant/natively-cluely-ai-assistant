// OSS / skip-premium gate: original suite lives in ProfileGroundingV2.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ProfileGroundingV2.premium-impl.mjs')).href);
}
