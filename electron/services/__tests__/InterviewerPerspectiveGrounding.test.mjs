// OSS / skip-premium gate: original suite lives in InterviewerPerspectiveGrounding.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'InterviewerPerspectiveGrounding.premium-impl.mjs')).href);
}
