// OSS / skip-premium gate: original suite lives in SkillCategorization.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'SkillCategorization.premium-impl.mjs')).href);
}
