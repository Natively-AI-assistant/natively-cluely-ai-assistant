// OSS / skip-premium gate: original suite lives in ProfileFactualRecallProductionPath.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ProfileFactualRecallProductionPath.premium-impl.mjs')).href);
}
