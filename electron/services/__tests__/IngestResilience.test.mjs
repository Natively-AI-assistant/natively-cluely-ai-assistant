// OSS / skip-premium gate: original suite lives in IngestResilience.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IngestResilience.premium-impl.mjs')).href);
}
