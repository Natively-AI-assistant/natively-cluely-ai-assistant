// OSS / skip-premium gate: original suite lives in InterviewerPerspectiveEval.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'InterviewerPerspectiveEval.premium-impl.mjs')).href);
}
