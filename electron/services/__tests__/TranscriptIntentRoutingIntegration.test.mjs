// OSS / skip-premium gate: original suite lives in TranscriptIntentRoutingIntegration.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'TranscriptIntentRoutingIntegration.premium-impl.mjs')).href);
}
