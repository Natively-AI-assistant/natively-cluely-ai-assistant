// OSS / skip-premium gate: original suite lives in KnowledgeOrchestratorIngest.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'KnowledgeOrchestratorIngest.premium-impl.mjs')).href);
}
