// OSS / skip-premium gate: original suite lives in PersonaFabricationFallbackProductionPath.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'PersonaFabricationFallbackProductionPath.premium-impl.mjs')).href);
}
