// OSS / skip-premium gate: original suite lives in HeuristicExtractor.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'HeuristicExtractor.premium-impl.mjs')).href);
}
