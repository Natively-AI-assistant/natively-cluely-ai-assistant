...
import {
  ...
  UNIVERSAL_EPOCH_SUMMARY_PROMPT, UNIVERSAL_SYSTEM_DESIGN_PROMPT, UNIVERSAL_FOLLOWUP_PROMPT, UNIVERSAL_FOLLOW_UP_QUESTIONS_PROMPT, UNIVERSAL_ASSIST_PROMPT,
  CUSTOM_SYSTEM_PROMPT, CUSTOM_ANSWER_PROMPT, CUSTOM_WHAT_TO_ANSWER_PROMPT,
  CUSTOM_RECAP_PROMPT, CUSTOM_SYSTEM_DESIGN_PROMPT, CUSTOM_FOLLOWUP_PROMPT, CUSTOM_FOLLOW_UP_QUESTIONS_PROMPT, CUSTOM_ASSIST_PROMPT
} from "./llm/prompts"
...
[END LANGUAGE OVERRIDE]\n\n`;
  ...
  private mapToCustomPrompt(prompt: string): string {
    ...
    if (prompt === UNIVERSAL_EPOCH_SUMMARY_PROMPT) return CUSTOM_RECAP_PROMPT;
    if (prompt === UNIVERSAL_SYSTEM_DESIGN_PROMPT) return CUSTOM_SYSTEM_DESIGN_PROMPT;
