// OSS / skip-premium gate: original suite lives in IngestInFlightSurvivesPanelClose2026_08_02.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IngestInFlightSurvivesPanelClose2026_08_02.premium-impl.mjs')).href);
}
