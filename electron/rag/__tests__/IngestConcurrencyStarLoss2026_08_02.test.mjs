// OSS / skip-premium gate: original suite lives in IngestConcurrencyStarLoss2026_08_02.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IngestConcurrencyStarLoss2026_08_02.premium-impl.mjs')).href);
}
