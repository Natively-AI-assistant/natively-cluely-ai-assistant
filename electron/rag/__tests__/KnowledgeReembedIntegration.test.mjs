// OSS / skip-premium gate: original suite lives in KnowledgeReembedIntegration.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'KnowledgeReembedIntegration.premium-impl.mjs')).href);
}
