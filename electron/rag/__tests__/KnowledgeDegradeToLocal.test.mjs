// OSS / skip-premium gate: original suite lives in KnowledgeDegradeToLocal.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'KnowledgeDegradeToLocal.premium-impl.mjs')).href);
}
