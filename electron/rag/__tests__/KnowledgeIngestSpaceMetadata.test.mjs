// OSS / skip-premium gate: original suite lives in KnowledgeIngestSpaceMetadata.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'KnowledgeIngestSpaceMetadata.premium-impl.mjs')).href);
}
