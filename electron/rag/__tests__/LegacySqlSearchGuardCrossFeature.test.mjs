// OSS / skip-premium gate: original suite lives in LegacySqlSearchGuardCrossFeature.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'LegacySqlSearchGuardCrossFeature.premium-impl.mjs')).href);
}
