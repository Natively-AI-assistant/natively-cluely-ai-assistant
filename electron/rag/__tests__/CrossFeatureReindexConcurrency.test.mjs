// OSS / skip-premium gate: original suite lives in CrossFeatureReindexConcurrency.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'CrossFeatureReindexConcurrency.premium-impl.mjs')).href);
}
