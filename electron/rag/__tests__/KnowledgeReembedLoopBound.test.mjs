// OSS / skip-premium gate: original suite lives in KnowledgeReembedLoopBound.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'KnowledgeReembedLoopBound.premium-impl.mjs')).href);
}
