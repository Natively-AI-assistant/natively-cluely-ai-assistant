// OSS / skip-premium gate: original suite lives in LiveBugKnowledgeModeMisfire2026_07_04.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'LiveBugKnowledgeModeMisfire2026_07_04.premium-impl.mjs')).href);
}
