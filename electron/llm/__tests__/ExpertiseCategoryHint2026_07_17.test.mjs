// OSS / skip-premium gate: original suite lives in ExpertiseCategoryHint2026_07_17.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ExpertiseCategoryHint2026_07_17.premium-impl.mjs')).href);
}
