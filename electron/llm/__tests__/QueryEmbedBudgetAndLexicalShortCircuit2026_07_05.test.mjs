// OSS / skip-premium gate: original suite lives in QueryEmbedBudgetAndLexicalShortCircuit2026_07_05.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'QueryEmbedBudgetAndLexicalShortCircuit2026_07_05.premium-impl.mjs')).href);
}
