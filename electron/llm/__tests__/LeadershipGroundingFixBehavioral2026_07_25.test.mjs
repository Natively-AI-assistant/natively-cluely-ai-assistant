// OSS / skip-premium gate: original suite lives in LeadershipGroundingFixBehavioral2026_07_25.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'LeadershipGroundingFixBehavioral2026_07_25.premium-impl.mjs')).href);
}
