// OSS / skip-premium gate: original suite lives in IntroPatternsLivePath2026_07_03.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IntroPatternsLivePath2026_07_03.premium-impl.mjs')).href);
}
