// OSS / skip-premium gate: original suite lives in PronounRegexShadowDivergence2026_07_26.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'PronounRegexShadowDivergence2026_07_26.premium-impl.mjs')).href);
}
