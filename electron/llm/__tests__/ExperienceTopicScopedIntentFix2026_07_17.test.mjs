// OSS / skip-premium gate: original suite lives in ExperienceTopicScopedIntentFix2026_07_17.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ExperienceTopicScopedIntentFix2026_07_17.premium-impl.mjs')).href);
}
