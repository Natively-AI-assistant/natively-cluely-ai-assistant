// OSS / skip-premium gate: original suite lives in IntroExperienceYearsFix2026_07_17.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'IntroExperienceYearsFix2026_07_17.premium-impl.mjs')).href);
}
