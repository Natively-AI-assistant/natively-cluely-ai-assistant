// OSS / skip-premium gate: original suite lives in ManualRealSessionFixes2026_06_12.premium-impl.mjs.
...
if (!fs.existsSync(premiumDist)) {
  ...
  await import(pathToFileURL(path.join(__dirname, 'ManualRealSessionFixes2026_06_12.premium-impl.mjs')).href);
}
