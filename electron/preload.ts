...
interface ElectronAPI {
  ...
  // Streaming listeners
  streamGeminiChat: (message: string, imagePaths?: string[], context?: string, options?: { skipSystemPrompt?: boolean, ignoreKnowledgeMode?: boolean, skipModeInjection?: boolean }) => Promise<void>
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  // Streaming Chat
  streamGeminiChat: (message: string, imagePaths?: string[], context?: string, options?: { skipSystemPrompt?: boolean, ignoreKnowledgeMode?: boolean, skipModeInjection?: boolean }) => ipcRenderer.invoke("gemini-chat-stream", message, imagePaths, context, options),
