...
- **SD route sticky ↔ SdSessionAuthority** — Armed sticky SD session promotes non-coding turns to `system_design_answer` (ADR 0004); problemKey alone is insufficient.
